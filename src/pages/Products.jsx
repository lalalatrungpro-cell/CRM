        ...
        <div
          ...
          >
            <div
              ...
              style={{ width: '100%', maxWidth: '640px', height: '100vh', background: '#0f172a', borderLeft: '1px solid rgba(255,255,255,0.1)', boxShadow: '-10px 0 35px rgba(0,0,0,0.7)', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}
            >
            <div style={{
              padding: '20px 24px',
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: '12.5px', color: '#94a3b8', margin: '3px 0 0 0' }}>
                    Cấu hình tên sản phẩm, thời hạn mặc định & bảng giá sỉ/lẻ
                  </p>
                </div>
              </div>
              <button
