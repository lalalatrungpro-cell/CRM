      ...
      {showDetailModal && (() => {
        ...
        return (
          ...
          >
            ...
            >
              <div className="modal-header" style={{ padding: '20px 24px', borderBottom: '1px solid rgba(255,255,255,0.08)', background: '#111827' }}>
                <div>
              ...
              <div style={{ padding: '16px 24px', borderTop: '1px solid rgba(255,255,255,0.08)', background: '#111827' }}>
          ...
          >
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <h2 style={{ fontSize: '19px', fontWeight: '800', color: '#fff', letterSpacing: '-0.01em', margin: 0 }}>
                      TẠO ĐƠN HÀNG MỚI (POS 360°)
                    </h2>
                  ...
                  <p style={{ fontSize: '12px', color: '#94a3b8', margin: '3px 0 0 0' }}>
                    Tạo đơn hàng & tự động đồng bộ Kho acc, Sổ quỹ và Công nợ khách
                  </p>
                </div>
              </div>
              <button
                ...
                style={{
                  ...
                  color: '#94a3b8', cursor: 'pointer', padding: '7px', borderRadius: '10px',
                  display: 'flex', alignItems: 'center', justifyContent: 'center'
                }}
              >
                <X size={18} />
