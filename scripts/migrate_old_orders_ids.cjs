...
console.log('Test dateToPrefix:');
console.log('2025-06-17 ->', dateToPrefix('2025-06-17'));
console.log('45825 ->', dateToPrefix(45825));
console.log('03/10/2025 ->', dateToPrefix('03/10/2025'));
